...
<head>
<meta charset="utf-8">
<title>MyEllaWallet</title>
<meta name="description" content="MyEllaWallet is a free, open-source, client-side interface for generating Ethereum wallets &amp; interacting with the blockchain easily &amp; securely. Double-check the URL ( ellaism.github.io/ellawallet ) before unlocking your wallet.">
<link rel="canonical" href="https://ellaism.github.io/ellawallet" />
...
<meta property="og:description" content="MyEllaWallet is a free, open-source, client-side interface for generating Ethereum wallets &amp; interacting with the blockchain easily &amp; securely. Double-check the URL ( ellaism.github.io/ellawallet ) before unlocking your wallet." />
...
@@if (site === 'mew' ) {
  <div class="small announcement annoucement-danger">
    <div class="container">
      ...
      <br />
      Make sure you're accessing the Ella wallet from <strong>https://ellaism.github.io/ellawallet</strong>
    </div>
  </div>
}
