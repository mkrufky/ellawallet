...
<footer class="footer" role="content" aria-label="footer" ng-controller='footerCtrl' >
  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--left">
      ...
      <p><span translate="FOOTER_1">Free, open-source, client-side interface for generating Ethereum wallets &amp; more. Interact with the Ethereum blockchain easily &amp; securely. Double-check the URL ( ellaism.github.io/ellawallet ) before unlocking your wallet.</span></p>
    ...
    <section class="footer--cent">
        ...
        <p>Check out Ellaism donation addresses <a href="https://github.com/ellaism/meta/blob/master/donations.md" target="_blank">here</a>.</p>
	</section>
