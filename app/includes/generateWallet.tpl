  ...
  <article class="block__wrap gen__1" ng-show="!wallet && !showGetAddress">
    ...
    <section class="block__main gen__1--inner">
      ...
      <div class="text-center">
        <strong>
          <a href="https://myetherwallet.github.io/knowledge-base/getting-started/creating-a-new-wallet-on-myetherwallet.html" target="_blank" rel="noopener" translate="GEN_Help_5">
